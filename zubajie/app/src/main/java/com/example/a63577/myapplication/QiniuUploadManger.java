...
public  class QiniuUploadManger {
    ...
    public String uploadSingleFile(final String filePath){

        final byte[]path=filePath.getBytes();
        final String key=getRandomString(20);
        final String[] token = {""};
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                System.out.println(responseStr+"0000000000000000000000000");
                JSON json=JSON.parseObject(responseStr);
                token[0] =((JSONObject) json).getString("token");
                uploadManager.put(filePath, key, token[0],
